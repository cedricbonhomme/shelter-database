...
SQLALCHEMY_DATABASE_URI = config.get("database", "database_url") + config.get(
...
ALLOWED_EXTENSIONS_DOCUMENT = set(
    [
        "doc",
        "docx",
        "pdf",
...
PUBLIC_PATH = os.path.join(PATH, config.get("misc", "public_path"))
SHELTERS_PICTURES_SERVER_PATH = os.path.join(
    PATH, config.get("misc", "shelters_pictures_server_path")
)
SHELTERS_PICTURES_BACKUP_PATH = os.path.join(
    PATH, config.get("misc", "shelters_pictures_backup_path")
)
SHELTERS_PICTURES_SITE_PATH = config.get("misc", "shelters_pictures_site_path")
SHELTERS_DOCUMENTS_SERVER_PATH = os.path.join(
    PATH, config.get("misc", "shelters_documents_server_path")
)
SHELTERS_DOCUMENTS_SITE_PATH = config.get("misc", "shelters_documents_site_path")
ATTRIBUTES_PICTURES_SERVER_PATH = os.path.join(
    PATH, config.get("misc", "attributes_pictures_server_path")
)
...
HUMANITARIAN_ID_AUTH_URI = config.get("humanitarian_id", "humanitarian_id_auth_uri")
HUMANITARIAN_ID_CLIENT_ID = config.get("humanitarian_id", "humanitarian_id_client_id")
HUMANITARIAN_ID_REDIRECT_URI = config.get(
    "humanitarian_id", "humanitarian_id_redirect_uri"
)
HUMANITARIAN_ID_APP_URI = config.get("humanitarian_id", "humanitarian_id_app_uri")
